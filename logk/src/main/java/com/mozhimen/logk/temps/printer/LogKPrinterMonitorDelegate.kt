...
class LogKPrinterMonitorDelegate : ILogKPrinter, ILogKPrinterMonitor, BaseUtilK(), LifecycleOwner {
    private val TITLE_OPEN_PANEL by lazy { UtilKRes.getString(com.mozhimen.logk.R.string.logk_view_provider_title_open) }
    private val TITLE_CLOSE_PANEL by lazy { UtilKRes.getString(com.mozhimen.logk.R.string.logk_view_provider_title_close) }
